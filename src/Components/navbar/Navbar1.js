      ...
      <nav className="bg-[#000000f5]  navbar ">
        <Container className="flex flex-nowrap justify-between items-center">
          ...
          <div className="flex items-center gap-3  z-10">
            <NavLink to={url("homepage.Auth.Login")} className="text-gray-400 bg-gray-900 hidden md:block px-4 py-2 rounded-md hover:text-white decoration-transparent">{t("Login")}</NavLink>
            <div className=" flex gap-2">
              <input
                ref={inputRef}
                type="text"
                className="bg-[#00000000] w-0 md:w-20  border-0 p-0 focus:border-primary rounded-md text-right outline-none"
              />
              <button
                role="img"
                aria-label="search"
        ...
        <Container>
          <div className="hamburgers">
            <div className="hamburgerlink">
              ...
              <hr />
              <NavLink to={url("homepage.announcements")} onClick={() => setOpen(false)} className="duyurular ">
                {t("PressReleasesandAnnouncements")}
              </NavLink>
              <NavLink to={url("homepage.Events")} onClick={() => setOpen(false)} className="haberler ">
                {t("Events")}
              </NavLink>
              <NavLink to={url("homepage.sponsorship")} onClick={() => setOpen(false)} className="haberler ">
                {t("DonationandSponsorship")}
              </NavLink>
              <NavLink to={url("homepage.contact")} onClick={() => setOpen(false)} className="haberler ">
                {t("Contact")}
              </NavLink>
            </div>
